//! Registry for managing all environment sources.
//!
//! Provides dynamic source registration and priority-based access.
...
impl SourceRegistry {
    ...
    pub fn register_sync(&self, source: Arc<dyn EnvSource>) -> SourceId {
        ...
        // Update path index for file sources
